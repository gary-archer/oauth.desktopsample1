...
export class LoginManager {
    ...
    private readonly _onCodeReceived: (code: string, redirectUri: string, verifier: string) => void;

    public constructor(
        configuration: OAuthConfiguration,
        metadata: AuthorizationServiceConfiguration,
        state: LoginState,
        onCodeReceived: (code: string, redirectUri: string, verifier: string) => void) {
